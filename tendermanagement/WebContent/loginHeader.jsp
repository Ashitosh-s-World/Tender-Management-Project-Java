...
<html lang="en">
  <head>
    ...
    <title>GCOC Tender Management System Project - Update</title>
        ...
        <div class="container" >
            <div class="navbar-header"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    ...
                    <a class="navbar-brand" href="#"><h1>GCOC Tender Management System</h1></a> <!-- Library Name fixed-->
                    <a href="#"><p> GCOC Team Project</p></a>
            </div>
